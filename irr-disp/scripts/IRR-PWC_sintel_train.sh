...
# datasets
SINTEL_HOME=/content/sintelall/MPI-Sintel-complete/

# model and checkpoint
MODEL=IRR_PWC
EVAL_LOSS=MultiScaleEPE_PWC_Bi_Occ_upsample_Sintel
CHECKPOINT="/content/irr/saved_check_point/pwcnet/IRR-PWC_things3d/checkpoint_latest.ckpt"
SIZE_OF_BATCH=1
...
--training_augmentation_crop="[84,68]" \
